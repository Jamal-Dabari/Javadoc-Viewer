...
public class JavaDocViewer extends Application {
                ...
                private HBox createNavBar() {
                                ...
                                navbar.getChildren().addAll(sidebarToggle, logo, title, searchField, spacer,
                                                                darkModeToggle);
                                return navbar;
                }
                ...
                private HBox createToolbar() {
                                ...
                                recentFilesCombo.setOnAction(e -> {
                                ...
                                // Update zoom label
                                Timeline zoomUpdater = new Timeline(new KeyFrame(Duration.millis(100), e -> {
                                ...
                                toolbar.getChildren().addAll(
                                                                backButton, forwardButton, sep1, recentFilesCombo,
                                                                spacer,
                                                                loadingIndicator, zoomOutButton, zoomLabel,
                                                                zoomInButton, resetZoomButton);
                                return toolbar;
                }
                ...
                private HBox createStatusBar() {
                                ...
                                Label shortcutsLabel = new Label(
                                                                "Ctrl+F: Search | Ctrl+B: Toggle Sidebar | Ctrl+D: Dark Mode");
                ...
                private VBox createSidebar() {
                                ...
                                fileTree.getSelectionModel().selectedItemProperty().addListener((obs, old, newVal) -> {
                ...
                private void toggleSidebar() {
                                ...
                                if (isSidebarVisible) {
                                                ...
                                                if (!splitPane.getItems().contains(sidebar)) {
                                                                ...
                                                                splitPane.setDividerPositions(prefs.getDouble(
                                                                                                "dividerPosition",
                                                                                                0.2));
                                                }
                ...
                private TreeItem<FileNode> buildFileTree(File directory) {
                                TreeItem<FileNode> root = new TreeItem<>(
                                                                new FileNode(directory.getName(), directory
                                                                                                .getAbsolutePath(),
                                                                                                false));
                                ...
                                if (directory.isDirectory()) {
                                                ...
                                                if (files != null) {
                                                                ...
                                                                for (File file : files) {
                                                                                if (file.isDirectory()) {
                                                                                                TreeItem<FileNode> item = buildFileTree(
                                                                                                                                file);
                ...
                private void addToRecentFiles(String filePath) {
                                ...
                                recentFilesCombo.getItems().addAll(
                                                                recentFiles.stream()
                ...
                private void filterFiles(String query) {
                                ...
                                try {
                                                long count = Files.walk(Paths.get(docsPath))
                ...
                private void toggleDarkMode() {
                                ...
                                if (!history.isEmpty() && historyIndex >= 0 && historyIndex < history.size()) {
                                                ...
                                                try {
                                                                ...
                                                                String styledContent = injectCustomStyles(content);
                                                                if (isDarkMode) {
                                                                                styledContent = injectDarkModeStyles(
                                                                                                                styledContent);
                                                                }
                                                                styledContent = injectCopyButtons(styledContent);
                                                                webEngine.loadContent(styledContent);
