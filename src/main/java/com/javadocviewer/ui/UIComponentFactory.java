...
public class UIComponentFactory {
  ...
  public static HBox createCustomTitleBar(Stage stage) {
    ...
    Button minimizeBtn = createWindowButton("─", "#10b981", e -> stage.setIconified(true));
    Button maximizeBtn =
        createWindowButton(
            "□",
            "#3b82f6",
    ...
    titleBar.getChildren().addAll(appIcon, titleLabel, spacer, minimizeBtn, maximizeBtn, closeBtn);

    return titleBar;
  }

  private static Button createWindowButton(
      String text, String hoverColor, javafx.event.EventHandler<javafx.event.ActionEvent> action) {
